...
final class Preferences: ObservableObject {
    ...
    /// back when Brau does (see Browser.appLeft). Off unless asked for.
    ...
    /// always was. Off, Brau still looks once a day and says so, and waits
    ...
    init() {
        ...
        // Brau: on unless turned off (upstream: off unless turned on).
