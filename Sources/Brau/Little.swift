...
// it with the site, Open in Brau and nothing else — to read and close, or
...
// window of its own: Open in Brau moves it into the browser's row, where
