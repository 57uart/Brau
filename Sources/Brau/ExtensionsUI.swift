            ...
            VStack(alignment: .leading, spacing: 18) {
                Card {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text("Or find it in the store and press Add to Brau on its page.")
...
struct StoreOffer: View {
    ...
    private struct Watch: View {
        ...
        var body: some View {
            // Only where the page's own "Add to Brau" isn't in place — a
               ...
               tab.storePlaced != id, !extensions.installed.contains(where: { $0.id == id }) {
                HStack(spacing: 12) {
                    Image(systemName: "puzzlepiece.extension")
                        ...
                        .foregroundStyle(Palette.muted)
                    Text(extensions.busy == id ? "Adding…" : "Add this extension to Brau")
                        .font(.system(size: 12.5))
                        .foregroundStyle(Palette.ink)
