    ...
    private func handle(_ request: [String: Any], _ given: @escaping ([String: Any]) -> Void) {
        ...
        default:
            answer(["error": "unknown command “\(verb)”", "commands": [
                "tabs", "open", "go", "close", "wait", "sleep", "select", "text", "eval", "click", "type", "submit", "shot", "probe", "key", "resize", "hit", "film", "window", "snapshot", "dragrow", "group", "pages", "picture", "place", "field", "bookmark", "menu", "space", "strip", "column", "ui",
            ]])
        }
    }
